...
class Lab_Comu_I_P1B(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.MultiplyCons = MultiplyCons = 1
        ...
        self._MultiplyCons_range = qtgui.Range(0, 2, 0.2, 1, 200)
        self._MultiplyCons_win = qtgui.RangeWidget(self._MultiplyCons_range, self.set_MultiplyCons, "MultiplyCons", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._MultiplyCons_win)
        ...
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_ff(MultiplyCons)
    ...
    def get_MultiplyCons(self):
        return self.MultiplyCons

    def set_MultiplyCons(self, MultiplyCons):
        self.MultiplyCons = MultiplyCons
        self.blocks_multiply_const_vxx_0.set_k(self.MultiplyCons)
