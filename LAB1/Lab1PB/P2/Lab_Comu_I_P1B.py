...
class Lab_Comu_I_P1B(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "LAB1B-P1", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("LAB1B-P1")
        ...
        self._samp_rate_range = qtgui.Range(1000, 40000, 1000, 2000, 200)
        ...
        self._freq_range = qtgui.Range(1000, 80000, 1000, 10000, 200)
