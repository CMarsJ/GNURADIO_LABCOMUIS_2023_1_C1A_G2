...
# Author: CARLOSCARRENO_JUANPINTO
...
class P1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "P1")
        ...
        self.analog_const_source_x_0 = analog.sig_source_c(0, analog.GR_CONST_WAVE, 0, 0, 500e-3)
...
def main(top_block_cls=P1, options=None):
